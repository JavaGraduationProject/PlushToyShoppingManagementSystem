	...
	<div id="rightContent">
	    ...
	    <div id="topResult">
		    <div id="info" style="width:330px;float:left">
				<div class="titleBg">热销商品</div>
				<div class="info_con" style="width:330px;height:525px;">
					<div class="products">
					<c:if test="${goodss1!=null && fn:length(goodss1)>0}">
					...
					<div style="text-align:center">	商品单价：<c:if test="${goods.goods_flag==2}"><span style="text-decoration: line-through;">￥${goods.goods_price1} </span></c:if>￥${goods.goods_price2}</div>
					</div>
					</c:forEach>
					</c:if> 
					</div>
		    ...
		    <div id="info" style="width:330px;float:right">
				<div class="titleBg">特价商品</div>
				<div class="info_con" style="width:330px;height:525px;">
					<div class="products">
					<c:if test="${goodss2!=null && fn:length(goodss2)>0}">
